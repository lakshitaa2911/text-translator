...
, 'odia': 'or', 'pashto': 'ps', 'persian': 'fa', 'polish': 'pl', 'portuguese': 'pt', 'punjabi': 'pa', 'romanian': 'ro'
...
#LABELS
label1 = Label(root,text = 'ENTER WORDS :', font = ('times',15,'italic bold'), bg = color, )
label1.place(x =5,y=40)

label2 = Label(root,text = 'TRANSLATED :', font = ('times',15,'italic bold'), bg = color, )
label2.place(x =5,y=100)

label3 = Label(root,text = '', font = ('times',15,'italic bold'), bg = color, )
label3.place(x =10,y=250)

# BUTTON
btn1 = Button(root, text = 'Click', bd = 10, bg = 'yellow', activebackground = 'red', width = 10, font = ('times',15,'italic bold'), command = tt)
